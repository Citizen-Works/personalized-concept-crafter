  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto z-10 relative">
        <h2 className="text-3xl md:text-5xl font-bold mb-8 md:mb-12 text-center text-white transform transition-all duration-700 translate-y-8 opacity-0">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center mb-10 md:mb-20">
          <div className="space-y-4 md:space-y-8">
            <div className="flex items-start gap-4 p-4 md:p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-md transform transition-all duration-700 delay-150 -translate-x-8 opacity-0 hover:scale-105">
            ...
            <div className="flex items-start gap-4 p-4 md:p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-md transform transition-all duration-700 delay-300 -translate-x-8 opacity-0 hover:scale-105">
            ...
            <div className="flex items-start gap-4 p-4 md:p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-md transform transition-all duration-700 delay-450 -translate-x-8 opacity-0 hover:scale-105">
          ...
          {!isMobile ? (
            <div className="relative h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-2xl transform transition-all duration-700 delay-300 translate-x-8 opacity-0">
              <img 
            ...
            <div className="relative h-[250px] rounded-xl overflow-hidden shadow-2xl my-4 transform transition-all duration-700 delay-300 translate-y-8 opacity-0">
              <img 
                src="https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?auto=format&fit=crop&w=1000&q=80" 
                alt="Person stressed at computer"
                className="absolute inset-0 w-full h-full object-cover"
        ...
        <div className="text-center mt-8 md:mt-12 mb-6 md:mb-8 transform transition-all duration-700 delay-600 translate-y-8 opacity-0">
